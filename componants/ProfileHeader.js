...
export default function ProfileHeader() {
    return (
        <View>
            <View style={{ borderColor: 'white', borderStyle: 'solid', borderWidth: 3, padding: 4, borderRadius: 70, width: 115, alignItems: 'center' }}>
                <Image source={{ uri: "https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcTncxHwv7BXAjmaSBtTzrsp1mVdUkJGEKrUuA&usqp=CAU" }} style={{ width: 100, height: 100, borderRadius: 60 }} />
            </View>
        </View>
