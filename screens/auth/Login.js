import { View, Text, StyleSheet, TextInput, TouchableOpacity, Image, Button, Alert, Dimensions } from 'react-native'
...
export default function Login({ navigation }) {
    return (
        <View style={{ flex: 1, backgroundColor: 'red' }}>
            <View style={{ backgroundColor: 'blue', marginTop: height - 800, alignItems: 'center' }}>
                <Image source={{ uri: 'https://pathwayport.com/saasland/images/login@4x.png' }} style={{ width: width - 30, height: height - 500, backgroundColor: "green" }} resizeMode='contain'></Image>
            </View>
            <View style={{ backgroundColor: 'yellow', alignItems: 'center' }}>
                <View style={{ backgroundColor: 'skyblue', width: width - 30 }}>
                    ...
                    <View style={{
                        ...
                        <View style={{ backgroundColor: 'gray', alignItems: 'flex-end' }}>
